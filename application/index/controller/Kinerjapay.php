...
class Kinerjapay
{
    ...
    public function kpayProcess()
    {
        ...
        $sendResult = app('kinerjapay')->sendDataToCentral($status,$this->centerId,$this->fData['ts_id']);
        if (!$sendResult)
        {
