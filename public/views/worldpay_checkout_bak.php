            ...
            <section class="container">
                <section class="card">
                    <form class="checkout" id="card-form">
                        ...
                        <label class="label lable-text" for="card-pan">Card number <span class="type"></span></label>
                        <section id="card-pan" class="field"></section>

                        <section class="col-2">
                            <section class="col">
                                <label class="label lable-text" for="card-expiry">Expiry date</label>
                                <section id="card-expiry" class="field"></section>
                            </section>

                            <section class="col">
                                <label class="label lable-text" for="card-cvv">CVV</label>
    ...
    function handleStripeResponse(status, response) {
        ...
        try {
            if (response.error) {
                ...
                {
                    sendErrMessage(response.error.message)
                }
